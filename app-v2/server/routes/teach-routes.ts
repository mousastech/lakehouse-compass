...
/**
 * POST /api/teach — the learning-curve reducer. Given a finding/control's context,
 * asks the governed Claude endpoint (compass-llm) for step-by-step "how to apply".
